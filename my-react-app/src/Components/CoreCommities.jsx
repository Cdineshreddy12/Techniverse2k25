...
import { 
  Brain, Cpu, ChevronDown, Search, 
  Megaphone, Laptop2, Building, Sparkles, Users2
} from 'lucide-react';

const CommitteesComponent = () => {
  const [expandedSection, setExpandedSection] = useState('Core Committee');
  ...
  const committees = [
    ...
    },
    {
      ...
      members: [
        ...
        {name: "Mr. T Dileep Kumar", role: "Trainee, Physical Education"},
        {name: "Mr. Ch Krishnam Raju", role: "Trainee, Physical Education"},
      ],
    },
    {
      title: "Alumni Engagement Team",
      icon: Users2,
